...
//capture the user command, load to payload
typedef struct{
	uint8_t payload[10];
	uint32_t len;
}command_t;

//board hangi menüde olduğunu anlar ona göre verilen commandları değerlendirir mesela ledeffecte ise sadece e1 e2 e3 e4 commandları alır
typedef enum
{
	sMainMenu = 0,
	sLedEffect,
