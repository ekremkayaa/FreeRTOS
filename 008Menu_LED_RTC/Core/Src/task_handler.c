...
void menu_task(void *parameters){
	uint32_t cmd_addr; //command ı almak için
...
void process_command(command_t *cmd)
{
	...
	switch(curr_state)
	{
		case sMainMenu:
			...
			//eSetValueWithOverwrite diyerek kullanıcının verdiği komutu(cmd) handle_menu_task e ilettik, cmd nin pointer adresi gönderilir
		break;
